...
headers = {
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJibHVlIiwiaWRlbnRpdHkiOiJibHVlIiwiYXV0aG9yaXRpZXMiOlsiUk9MRV9VU0VSIl0sImlhdCI6MTU3Mjk4Nzc0OSwiZXhwIjoxNTcyOTg4MzQ5fQ.UXyl4JN1j6rI_FthNB8Wp5pV2OtVUAHo4iUPZEIhMZV1MdKwNJKTt51dg1fDdx3kPUnDEFPfRttxnf81QsuT6Q'
}

#conn.request("GET", "/rol?page=0", headers=headers)

conn.request("GET", "/movie?page=0", headers=headers)
